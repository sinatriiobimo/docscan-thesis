...
class Scanner():
    ...
    def doc_scanner(self, image_path):
    ...
    def calibrate_to_original_size(self, four_points):
        ...
        four_points_ori = four_points * multiplier
        four_points_ori = four_points_ori.astype(int)
        
        wrap_image = four_point_transform(self.image,four_points_ori)
